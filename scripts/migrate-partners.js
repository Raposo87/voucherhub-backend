...
async function run() {
  const partnerInserts = [
    ...
    `ALTER TABLE partners ADD COLUMN IF NOT EXISTS max_vouchers INTEGER DEFAULT NULL;`,
    ...
    CREATE TABLE IF NOT EXISTS partners (
      ...
      max_vouchers INTEGER DEFAULT NULL,
...
`
INSERT INTO partners (slug, name, email, phone, location, price_original_cents, voucher_validity_days, pin, stripe_account_id) VALUES
  ('azonda-surf-club', 'Azonda Surf Club', 'ian.fcosta@icloud.com', '+351 913 545 440', 'Classico By Olivier', 4000, 120, '2244', 'acct_1ScCLRL0iebOL7yv')
ON CONFLICT (slug) DO UPDATE SET 
    name = EXCLUDED.name,
    email = EXCLUDED.email,
    phone = EXCLUDED.phone,
